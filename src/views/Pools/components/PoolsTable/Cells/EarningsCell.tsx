...
const EarningsCell: React.FC<EarningsCellProps> = ({ pool, account, userDataLoaded }) => {
  ...
  // These will be reassigned later if its Auto UERN vault
  ...
  const labelText = isAutoVault ? t('Recent UERN profit') : t('%asset% Earned', { asset: earningToken.symbol })
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      <Balance fontSize="16px" value={autoCakeToDisplay} decimals={3} bold unit=" UERN" />
